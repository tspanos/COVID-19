...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog="Wide CSSEGISandData Covid-19 to Narrow",
                                     description='Downloads wide CSSEGISandData Covid-19 datasets and makes them '
                                                 'narrow. Additionally, adds some columns for reporting. '
                                                 'Outputs a CSV.')
    parser.add_argument('-output', action='store', default='global.csv', required=False, help='Output global CSV path.')
